...
p(h.delete_if { |_k, v| v < 3.5 })

# Ex 10
p { name: 'bob', properties: ['pizza lover', 'barbecue enjoyer'] }
p [{ a: 1, b: 2 }, { c: 3, d: 4 }]
...
contact_info = %i[email address phone]

contacts = { 'Joe Smith' => {}, 'Sally Johnson' => {} }

contacts.each_with_index do |(_contact_name, contact_details), contact_index|
